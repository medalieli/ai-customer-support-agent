...
| M4 | COMPLETE | Knowledge ingestion and retrieval | Versioned tenant-scoped EN/FR Markdown/text/PDF ingestion runs through ARQ; active-ready filtering, PostgreSQL FTS + pgvector RRF, local reranking and durable citation validation pass 34 backend tests at 90.53% coverage. The 13-case synthetic evaluation measures Recall@5 1.0 and MRR 1.0 with zero unsupported/isolation false positives. |
