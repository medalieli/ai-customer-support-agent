...
export type Ticket = { id: string; conversation_id: string; customer_id: string; customer_name: string; customer_email: string; customer_locale: string; reason_code: string; priority: string; status: string; assigned_staff_id: string | null; summary: Record<string, unknown>; version: number; created_at: string };
