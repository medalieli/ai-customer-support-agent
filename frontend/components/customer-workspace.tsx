...
export function CustomerWorkspace() {
  ...
  useEffect(() => { if (!active || active.ownership_state === "ai_active") return; const timer = window.setInterval(() => { void refreshMessages(active); }, 2500); return () => window.clearInterval(timer); }, [active, refreshMessages]);
